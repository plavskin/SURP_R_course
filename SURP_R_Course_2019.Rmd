...
To download R, go [here](https://cran.rstudio.com/), and select to download R for Linux, Windows, or Mac, depending on what system your computer uses.

To download Rstudio, go [here](https://www.rstudio.com/products/rstudio/download/#download), and again download the version of Rstudio appropriate for your computer.
...
**NEED A SECTION ON R NOTEBOOK SYNTAX**
